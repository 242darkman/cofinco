  ...
  return (
    <div className="p-4 max-w-6xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-lg font-bold text-white">Restitutions Frais</h1>
          <p className="text-slate-500 text-xs">Gérer les remboursements des frais de dossier</p>
        </div>
        <button
           onClick={() => refetch()}
      ...
      <div className="bg-slate-800/50 rounded-xl border border-slate-700 overflow-hidden">
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="bg-slate-900/50 text-slate-500 text-xs border-b border-slate-700">
          ...
          <tbody className="divide-y divide-slate-700/50">
            {isLoading ? (
               <tr>
                  <td colSpan={6} className="px-3 py-8 text-center text-slate-500 text-sm">Chargement...</td>
               </tr>
            ) : filteredRefunds.length === 0 ? (
               <tr>
                  <td colSpan={6} className="px-3 py-8 text-center text-slate-600 text-sm italic">Aucun remboursement</td>
               </tr>
            ) : (
