    ...
    >
      ...
      {isVisible && (
        <span
          ...
          role="tooltip"
        >
          <span className={`relative block px-2.5 py-1.5 text-xs font-medium text-content-primary bg-surface-elevated rounded-lg shadow-lg normal-case tracking-normal ${maxWidth ? '' : 'whitespace-nowrap'}`} style={maxWidth ? { maxWidth, whiteSpace: 'normal' } : undefined}>
            {content}
            <span
