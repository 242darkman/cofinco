...
const translations: Translations = {
  ...
  menuCartesPointage: { fr: 'Cartes de Pointage', en: 'Punch Cards' },
  menuCredits: { fr: 'Crédits', en: 'Credits' },
  menuRemboursements: { fr: 'Restitutions Frais', en: 'Fee Refunds' },
  ...
  menuAdministrateur: { fr: 'Administration', en: 'Administrator' },
  ...
  remiseDesFonds: { fr: 'Remise des fonds agent', en: 'Agent fund settlement' },
  historiqueAgent: { fr: 'Historique des opérations', en: 'Operations history' },
  disponibleAPurement: { fr: "Disponible à l'apurement", en: 'Available for settlement' },
  choisirCaisseDestination: { fr: 'Choisir la caisse de destination', en: 'Choose destination cash register' },
  sommeAPurement: { fr: 'Somme à apurer', en: 'Amount to settle' },
  observationsSettlement: { fr: 'Observations (facultatif)', en: 'Observations (optional)' },
  remiseEffectuee: { fr: 'Remise effectuée avec succès', en: 'Settlement completed successfully' },
  erreurRemise: { fr: 'Erreur lors de la remise', en: 'Error during settlement' },
  rechercheOpRefClient: { fr: 'Référence, client, caisse...', en: 'Reference, client, cash box...' },
  tousLesTypes: { fr: 'Tous les types', en: 'All types' },
  collectes: { fr: 'Collectes', en: 'Collections' },
  remisesApurements: { fr: 'Remises (Apurements)', en: 'Settlements' },
  tousLesStatuts: { fr: 'Tous les statuts', en: 'All statuses' },
  apure: { fr: 'Apuré', en: 'Settled' },
  detailsRecu: { fr: 'Détails / Reçu', en: 'Details / Receipt' },
  ...
  // Dashboard v2
  toutesAgences: { fr: 'Toutes les agences', en: 'All agencies' },
  agencePrincipale: { fr: 'Agence Principale', en: 'Main Agency' },
  actifs: { fr: 'actifs', en: 'active' },
  selectionnerAgence: { fr: 'SÉLECTIONNER UNE AGENCE', en: 'SELECT AN AGENCY' },
  agencesDisponibles: { fr: 'agences disponibles', en: 'agencies available' },
  repartitionPortefeuille: { fr: 'Répartition Portefeuille', en: 'Portfolio Distribution' },
  vueDensembleComptes: { fr: "Vue d'ensemble par produit", en: 'Overview by product' },
  global: { fr: 'GLOBAL', en: 'GLOBAL' },
  encaisseDisponible: { fr: 'ENCAISSE DISPONIBLE', en: 'CASH ON HAND' },
  volumePortefeuille: { fr: 'Volume Portefeuille', en: 'Portfolio Volume' },
  activiteAgents: { fr: 'Activité Agents', en: 'Agent Activity' },
  aucuneUrgence: { fr: 'Aucune urgence.', en: 'No urgency.' },
  momentIdealProspecter: { fr: "C'est le moment idéal pour prospecter !", en: "It's the perfect time to prospect!" }, 
  enLigne: { fr: 'En ligne', en: 'Online' },
  horsLigne: { fr: 'Hors ligne', en: 'Offline' },
  operationCaisse: { fr: 'Opération Caisse', en: 'Cash Operation' },
  creditRapide: { fr: 'Crédit Rapide', en: 'Quick Credit' },
  collecteTontine: { fr: 'Collecte Tontine', en: 'Tontine Collection' },
  demandesAttente: { fr: 'Demandes en attente', en: 'Pending requests' },
  validationRequise: { fr: 'Nécessitent votre validation', en: 'Require your validation' },
  echeancesRetard: { fr: 'Échéances en retard', en: 'Overdue installments' },
  aRelancer: { fr: 'À relancer aujourd\'hui', en: 'To follow up today' },
  voirTout: { fr: 'Voir tout', en: 'View all' },
  alertesClients: { fr: 'Alertes Clients', en: 'Client Alerts' },
  ...
  developPortfolio: { fr: 'Profitez-en pour développer le portefeuille.', en: 'Take the opportunity to grow the portfolio.' },
  santeFinanciere: { fr: 'SANTÉ & RISQUE', en: 'HEALTH & RISK' },
  risquePar30: { fr: 'Risque (PAR 30)', en: 'Risk (PAR 30)' },
  ciblePar30: { fr: 'Cible: < 3.0%', en: 'Target: < 3.0%' },
  liquidite: { fr: 'Liquidité', en: 'Liquidity' },
  ratioLiquidite: { fr: 'Ratio L/D', en: 'L/D Ratio' },
