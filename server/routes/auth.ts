...
/**
 * Generate a secure password that meets the platform's password policy:
 * - Min 12 chars, at least 1 uppercase, 1 lowercase, 1 digit, 1 special (@$!%*?&)
 */
function generateSecurePassword(): string {
  ...
  // Fill remaining 8 chars from all pool (total = 12)
