...
const ACCOUNTING_RULES_DATA = [
  ...
  // --- Décaissement crédit (alias LOAN_DISBURSEMENT) ---
  {
    code: 'LOAN_DECAISS_CASH',
    name: 'Décaissement prêt espèces',
    description: 'Décaissement prêt en espèces (alias LOAN_DISBURSEMENT)',
    sourceType: 'MOUVEMENT',
    ...
    debitAccount: '2711',
    creditAccount: '521',
    descriptionTemplate: 'Décaissement prêt #{creditNumber} - {clientName}',
    priority: 10,
  },
  {
    code: 'LOAN_DECAISS_MTN',
    name: 'Décaissement prêt MTN',
    description: 'Décaissement prêt via MTN (alias LOAN_DISBURSEMENT)',
    sourceType: 'MOUVEMENT',
    eventType: 'LOAN_DISBURSEMENT',
    paymentMethod: 'MOBILE_MONEY',
    provider: 'MTN',
    ...
    debitAccount: '2711',
    creditAccount: '5781',
    descriptionTemplate: 'Décaissement prêt #{creditNumber} MTN - {clientName}',
    priority: 10,
  },
  {
    code: 'LOAN_DECAISS_AIRTEL',
    name: 'Décaissement prêt Airtel',
    description: 'Décaissement prêt via Airtel (alias LOAN_DISBURSEMENT)',
    sourceType: 'MOUVEMENT',
    eventType: 'LOAN_DISBURSEMENT',
    paymentMethod: 'MOBILE_MONEY',
    provider: 'AIRTEL',
    ...
    debitAccount: '2711',
    creditAccount: '5782',
    descriptionTemplate: 'Décaissement prêt #{creditNumber} Airtel - {clientName}',
    priority: 10,
  },
  {
    code: 'LOAN_DECAISS_COMPTE',
    name: 'Décaissement prêt vers compte',
    description: 'Mise à disposition prêt sur compte (alias LOAN_DISBURSEMENT)',
    sourceType: 'MOUVEMENT',
    eventType: 'LOAN_DISBURSEMENT',
    paymentMethod: 'TRANSFER',
    journalCode: 'CRD',
    debitAccount: '2711',
    creditAccount: '4111',
    descriptionTemplate: 'Décaissement prêt #{creditNumber} vers compte - {clientName}',
    priority: 10,
  },
  ...
  // --- Remboursement crédit (alias LOAN_REPAYMENT) ---
  {
    code: 'LOAN_REMBOURS_CASH',
    name: 'Remboursement prêt espèces',
    description: 'Remboursement prêt en espèces (alias LOAN_REPAYMENT)',
    sourceType: 'MOUVEMENT',
    ...
    debitAccount: '521',
    creditAccount: '2711',
    descriptionTemplate: 'Remboursement prêt #{creditNumber} - {clientName}',
    priority: 20,
  },
  {
    code: 'LOAN_REMBOURS_MTN',
    name: 'Remboursement prêt MTN',
    description: 'Remboursement prêt via MTN (alias LOAN_REPAYMENT)',
    sourceType: 'MOUVEMENT',
    eventType: 'LOAN_REPAYMENT',
    paymentMethod: 'MOBILE_MONEY',
    provider: 'MTN',
    ...
    debitAccount: '5781',
    creditAccount: '2711',
    descriptionTemplate: 'Remboursement prêt #{creditNumber} MTN - {clientName}',
    priority: 20,
  },
  {
    code: 'LOAN_REMBOURS_AIRTEL',
    name: 'Remboursement prêt Airtel',
    description: 'Remboursement prêt via Airtel (alias LOAN_REPAYMENT)',
    sourceType: 'MOUVEMENT',
    eventType: 'LOAN_REPAYMENT',
    paymentMethod: 'MOBILE_MONEY',
    provider: 'AIRTEL',
    ...
    debitAccount: '5782',
    creditAccount: '2711',
    descriptionTemplate: 'Remboursement prêt #{creditNumber} Airtel - {clientName}',
    priority: 20,
  },
...
async function seedNotificationSystem(context: SeedContext, dryRun: boolean): Promise<SeedStepResult[]> {
  ...
  const smtpFromName = process.env.SMTP_FROM_NAME || APP_NAME;
  ...
  const mtnSenderId = process.env.MTN_SMS_SENDER_ID || APP_SENDER_ID;
  ...
  // 3. Email Templates — Professional HTML with ' + APP_NAME + ' branding
  // Reusable email layout wrapper
  const emailWrap = (body: string) => `<!DOCTYPE html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>${APP_NAME}</title></head><body style="margin:0;padding:0;background:#f4f6f9;font-family:Arial,Helvetica,sans-serif"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f4f6f9"><tr><td align="center" style="padding:24px 12px"><table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08)"><tr><td style="background:linear-gradient(135deg,#1b2d4b 0%,#0f766e 100%);padding:24px 32px;text-align:center"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding-bottom:10px"><img src="cid:company-logo" alt="${APP_NAME_HTML}" width="64" height="64" style="border-radius:10px;display:block;margin:0 auto"></td></tr><tr><td align="center"><span style="font-size:28px;font-weight:bold;color:#fff;letter-spacing:1px">${APP_NAME_HTML}</span></td></tr><tr><td align="center" style="padding-top:4px"><span style="font-size:12px;color:rgba(255,255,255,0.8);letter-spacing:2px">Votre partenaire microfinance</span></td></tr></table></td></tr><tr><td style="padding:32px">${body}</td></tr><tr><td style="background:#f8f9fa;padding:20px 32px;border-top:1px solid #e9ecef"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td style="font-size:12px;color:#868e96;line-height:1.5">${APP_NAME_HTML} - Microfinance<br>Boulevard Denis Sassou, Brazzaville<br>+242 06 000 00 00</td><td align="right" style="font-size:11px;color:#adb5bd">Cet email a ete envoye automatiquement.<br>Merci de ne pas y repondre.</td></tr></table></td></tr></table></td></tr></table></body></html>`;

  const EMAIL_TEMPLATES_DATA = [
    {
      code: 'OTP_CODE_EMAIL',
      nom: 'Code OTP par email',
      subject: 'Votre code de verification - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour, votre code de verification est : {{otpCode}}. Ce code expire dans {{expiryMinutes}} minutes. ' + APP_NAME + '',
    ...
    },
    {
      ...
      nom: 'Credit approuve',
      subject: 'Votre credit a ete approuve - ' + APP_NAME + '',
      ...
      contenuText: 'Felicitations {{clientName}} ! Votre demande de credit de {{amount}} FCFA a ete approuvee. Passez a notre agence pour finaliser. ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Decaissement de votre credit - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, le decaissement de votre credit de {{amount}} FCFA a ete effectue. ' + APP_NAME + '',
      placeholders: 'clientName,amount',
    ...
    },
    {
      ...
      subject: 'Code de reinitialisation - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{userName}}, votre code de reinitialisation est : {{otpCode}}. Ce code expire dans {{expiryMinutes}} minutes. ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Transfert effectue - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, un transfert de {{amount}} FCFA a ete effectue. Reference : {{reference}}. ' + APP_NAME + '',
    ...
    },
    {
      ...
      nom: 'Statut conge',
      subject: 'Mise a jour de votre demande de conge - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{employeeName}}, votre demande de conge ({{leaveType}}) du {{startDate}} au {{endDate}} a ete {{status}}. ' + APP_NAME + '',
    ...
    // ---- Phase 1: Credit templates ----
    {
      ...
      subject: 'Votre demande de credit a ete recue - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, votre demande de credit N°{{creditNumber}} de {{amount}} FCFA a ete recue. Vous serez notifie de l\'avancement. ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Votre dossier de credit est en cours d\'enquete - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, votre dossier {{creditNumber}} est en cours d\'enquete par {{agentName}}. Assurez-vous que vos documents sont a jour. ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Echeance de remboursement depassee - ' + APP_NAME + '',
      ...
      contenuText: 'Attention {{clientName}}, votre echeance de remboursement du credit {{creditNumber}} est depassee de {{daysOverdue}} jour(s). Montant restant : {{amount}} FCFA. Regularisez votre situation. ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Rappel : echeance de remboursement proche - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, rappel : echeance de remboursement du credit {{creditNumber}} de {{amount}} FCFA le {{dueDate}}. ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Felicitations ! Votre credit est solde - ' + APP_NAME + '',
      ...
      contenuText: 'Felicitations {{clientName}} ! Votre credit {{creditNumber}} a ete entierement rembourse ({{totalPaid}} FCFA). ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Votre demande de remboursement a ete approuvee - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, votre remboursement de {{amount}} FCFA (ref: {{reference}}) a ete approuve. ' + APP_NAME + '',
      placeholders: 'clientName,amount,reference',
    ...
    },
    {
      ...
      subject: 'Remboursement effectue - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, le remboursement de {{amount}} FCFA (ref: {{reference}}) a ete effectue. ' + APP_NAME + '',
      placeholders: 'clientName,amount,reference',
    ...
    // ── Tontine email templates ──
    {
      ...
      subject: 'Bienvenue dans la tontine {{tontineName}} - ' + APP_NAME + '',
      ...
      contenuText: 'Bienvenue {{clientName}} ! Vous etes inscrit(e) a la tontine {{tontineName}}. Cotisation: {{amount}} FCFA ({{frequence}}). ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Cotisation enregistree - {{tontineName}} - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, votre cotisation de {{amount}} FCFA pour la tontine {{tontineName}} a ete enregistree. ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Retard de cotisation - {{tontineName}} - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': Bonjour {{clientName}}, votre cotisation de {{amount}} FCFA pour {{tontineName}} est en retard de {{daysOverdue}} jours (echeance: {{dueDate}}). Regularisez rapidement.',
    ...
    },
    {
      ...
      subject: 'Penalite appliquee - {{tontineName}} - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': Bonjour {{clientName}}, une penalite de {{montantPenalite}} FCFA a ete appliquee sur {{tontineName}} ({{motif}}). Contactez votre agence.',
    ...
    },
    {
      ...
      subject: 'Distribution approuvee - {{tontineName}} - ' + APP_NAME + '',
      ...
      contenuText: 'Felicitations {{clientName}} ! Distribution tontine {{tontineName}} approuvee: {{amount}} FCFA ({{payoutMethod}}). ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Distribution effectuee - {{tontineName}} - ' + APP_NAME + '',
      ...
      contenuText: 'Felicitations {{clientName}} ! Distribution tontine {{tontineName}}: {{amount}} FCFA versee (Ref: {{reference}}). ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Nouveau cycle demarre - {{tontineName}} - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, cycle {{cycleNumber}} de la tontine {{tontineName}} a demarre le {{startDate}}. Les cotisations sont ouvertes. ' + APP_NAME + '',
    ...
    },
    {
      ...
      nom: 'Compte active',
      subject: 'Votre compte est maintenant actif - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, votre compte {{accountType}} N°{{accountNumber}} est actif ! Depot initial: {{amount}} FCFA. ' + APP_NAME + '',
    ...
    },
    {
      ...
      nom: 'Depot confirme',
      subject: 'Depot effectue sur votre compte - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, depot de {{amount}} FCFA sur compte {{accountNumber}}. Solde: {{balance}} FCFA. ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Retrait effectue sur votre compte - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, retrait de {{amount}} FCFA sur compte {{accountNumber}}. Solde: {{balance}} FCFA. ' + APP_NAME + '',
      placeholders: 'clientName,accountNumber,amount,balance',
    ...
    },
    {
      ...
      nom: 'Compte bloque',
      subject: 'Votre compte a ete bloque - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{clientName}}, votre compte {{accountNumber}} a ete bloque ({{motif}}). Les depots restent autorises. Contactez votre agence.',
    ...
    },
    {
      ...
      nom: 'Compte debloque',
      subject: 'Votre compte a ete debloque - ' + APP_NAME + '',
      ...
      contenuText: 'Bonne nouvelle {{clientName}} ! Votre compte {{accountNumber}} a ete debloque. Operations entierement disponibles. ' + APP_NAME + '',
    ...
    },
    {
      code: 'ACCOUNT_CLOSED',
      nom: 'Compte cloture',
      subject: 'Cloture de votre compte - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, votre compte {{accountType}} N°{{accountNumber}} a ete cloture. Merci de votre confiance. ' + APP_NAME + '',
      placeholders: 'clientName,accountNumber,accountType',
    ...
    },
    {
      ...
      subject: 'Capitalisation de vos interets - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, interets de {{interestAmount}} FCFA credites sur compte {{accountNumber}}. Solde: {{newBalance}} FCFA. ' + APP_NAME + '',
    ...
    // ---- Phase 4: Operations & Securite templates ----
    {
      ...
      subject: 'Demande de transfert en attente - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': Demande de transfert {{reference}} ({{typeTransfert}}) de {{amount}} FCFA en attente de validation.',
    ...
    },
    {
      ...
      subject: 'Transfert rejete - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': Transfert {{reference}} de {{amount}} FCFA rejete. Motif: {{reason}}.',
    ...
    },
    {
      ...
      subject: 'Virement programme execute - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{clientName}}, virement programme de {{amount}} FCFA execute ({{fromAccount}} vers {{toAccount}}). ' + APP_NAME + '',
    ...
    },
    {
      ...
      subject: 'Echec de votre virement programme - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{clientName}}, virement programme de {{amount}} FCFA ({{fromAccount}}) echoue: {{errorMessage}}. {{retryInfo}}.',
    ...
    },
    {
      ...
      subject: 'Votre demande de conge a ete enregistree - ' + APP_NAME + '',
      ...
      contenuText: 'Bonjour {{employeeName}}, votre demande de conge ({{leaveType}}) du {{startDate}} au {{endDate}} ({{daysRequested}} jours) a ete enregistree. ' + APP_NAME + '',
    ...
    {
      code: 'HR_LEAVE_REQUESTED_TO_HR',
      nom: 'Nouvelle demande de conge (notif RH)',
      subject: 'Nouvelle demande de conge de {{employeeName}} - ' + APP_NAME + '',
      contenuHtml: emailWrap('<h2 style="color:#1b2d4b;margin:0 0 16px">Nouvelle demande de conge</h2><p style="color:#495057;line-height:1.6"><strong>{{employeeName}}</strong> a soumis une demande de conge necessitant votre attention.</p><table role="presentation" style="background:#eff6ff;border-radius:8px;width:100%;margin:20px 0" cellpadding="0" cellspacing="0"><tr><td style="padding:16px 20px"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td style="padding:4px 0"><span style="color:#868e96;font-size:13px">Employe</span></td><td align="right"><strong style="color:#1b2d4b">{{employeeName}}</strong></td></tr><tr><td style="padding:4px 0"><span style="color:#868e96;font-size:13px">Type de conge</span></td><td align="right"><strong style="color:#1b2d4b">{{leaveType}}</strong></td></tr><tr><td style="padding:4px 0"><span style="color:#868e96;font-size:13px">Periode</span></td><td align="right"><strong style="color:#1b2d4b">{{startDate}} - {{endDate}}</strong></td></tr><tr><td style="padding:4px 0"><span style="color:#868e96;font-size:13px">Jours demandes</span></td><td align="right"><strong style="color:#1b2d4b">{{daysRequested}} jours</strong></td></tr></table></td></tr></table><p style="color:#495057;line-height:1.6">Connectez-vous a la plateforme pour traiter cette demande.</p>'),
      contenuText: '' + APP_NAME + ': {{employeeName}} a soumis une demande de conge ({{leaveType}}) du {{startDate}} au {{endDate}} ({{daysRequested}} jours). A traiter.',
      placeholders: 'employeeName,leaveType,startDate,endDate,daysRequested',
    ...
    },
    {
      ...
      subject: 'Demande de conge de {{employeeName}} - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{employeeName}} demande un conge ({{leaveType}}) du {{startDate}} au {{endDate}}. Connectez-vous pour approuver ou refuser.',
    ...
    },
    {
      ...
      subject: 'Nouvelle demande de document de {{employeeName}} - ' + APP_NAME + '',
      contenuHtml: emailWrap('<h2 style="color:#1b2d4b;margin:0 0 16px">Nouvelle demande de document</h2><p style="color:#495057;line-height:1.6"><strong>{{employeeName}}</strong> a soumis une demande de document.</p><table role="presentation" style="background:#eff6ff;border-radius:8px;width:100%;margin:20px 0" cellpadding="0" cellspacing="0"><tr><td style="padding:16px 20px"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td style="padding:4px 0"><span style="color:#868e96;font-size:13px">Employe</span></td><td align="right"><strong style="color:#1b2d4b">{{employeeName}}</strong></td></tr><tr><td style="padding:4px 0"><span style="color:#868e96;font-size:13px">Type de document</span></td><td align="right"><strong style="color:#1b2d4b">{{documentType}}</strong></td></tr><tr><td style="padding:4px 0"><span style="color:#868e96;font-size:13px">Urgent</span></td><td align="right"><strong style="color:#1b2d4b">{{urgence}}</strong></td></tr></table></td></tr></table><p style="color:#495057;line-height:1.6">Connectez-vous a la plateforme pour traiter cette demande.</p>'),
      contenuText: '' + APP_NAME + ': {{employeeName}} demande un document ({{documentType}}). Urgence: {{urgence}}. A traiter.',
      placeholders: 'employeeName,documentType,urgence',
      description: 'Notification RH pour nouvelle demande de document',
    },
    {
      code: 'SESSION_FORCE_CLOSED',
      nom: 'Session caisse fermee',
      subject: 'Session de caisse fermee automatiquement - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{userName}}, votre session de caisse a ete fermee automatiquement apres {{hoursInactive}}h d\'inactivite. Ouvrez une nouvelle session.',
    ...
    },
    {
      ...
      subject: 'Votre mot de passe a ete modifie - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{userName}}, votre mot de passe a ete modifie. Si ce n\'etait pas vous, contactez immediatement votre administrateur.',
    ...
    },
    {
      ...
      subject: 'Nouvelle prospection enregistree - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': Prospection enregistree par {{agentName}}. Prospect: {{prospectName}}, Localisation: {{location}}.',
    ...
    },
    {
      ...
      subject: 'Votre paiement a ete confirme - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{clientName}}, paiement de {{amount}} FCFA ({{paymentType}}) confirme.{{#if reference}} Ref: {{reference}}.{{/if}} Merci !',
    ...
    // ── Phase 6: Codes d'accès caisse & Permissions temporaires ──
    {
      ...
      subject: 'Votre code d\'acces caisse - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{userName}}, votre code d\'acces caisse: {{code}}. Type: {{codeType}}. Valide {{validityHours}}h, donne {{authorizationHours}}h d\'acces.{{#if description}} Motif: {{description}}.{{/if}} Ne partagez jamais ce code.',
    ...
    },
    {
      ...
      subject: 'Votre code d\'acces caisse expire bientot - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{userName}}, votre code d\'acces caisse ({{code}}) expire dans {{timeRemaining}}. Utilisez-le rapidement ou demandez un nouveau code.',
    ...
    },
    {
      ...
      subject: 'Permission temporaire accordee - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{userName}}, permission "{{permissionName}}" ({{permissionCode}}) accordee jusqu\'au {{expiresAt}} par {{grantedBy}}. Motif: {{reason}}.',
    ...
    },
    {
      ...
      subject: 'Permission temporaire expire bientot - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{userName}}, permission "{{permissionName}}" expire dans {{timeRemaining}} ({{expiresAt}}). Contactez votre responsable si besoin.',
    ...
    },
    {
      ...
      subject: 'Permission temporaire expiree - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{userName}}, votre permission "{{permissionName}}" ({{permissionCode}}) a expire le {{expiredAt}}. Demandez une nouvelle autorisation si necessaire.',
    ...
    },
    {
      ...
      subject: 'Permission temporaire revoquee - ' + APP_NAME + '',
      ...
      contenuText: '' + APP_NAME + ': {{userName}}, permission "{{permissionName}}" ({{permissionCode}}) revoquee par {{revokedBy}}.{{#if reason}} Motif: {{reason}}.{{/if}}',
  ...
  const NEW_SMS_TEMPLATES_DATA = [
    {
      code: 'OTP_CODE',
      nom: 'Code OTP SMS',
      contenu: '' + APP_NAME + ': Votre code de verification est {{otpCode}}. Expire dans {{expiryMinutes}} min. Ne partagez jamais ce code.',
      placeholders: 'otpCode,expiryMinutes',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, votre demande de credit n\'a pas ete retenue. Contactez votre agence. ' + APP_NAME + '',
      placeholders: 'clientName',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, votre credit de {{amount}} FCFA a ete decaisse. ' + APP_NAME + '',
      placeholders: 'clientName,amount',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, un virement de {{amount}} FCFA est programme pour le {{scheduledDate}}. ' + APP_NAME + '',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, transfert de {{amount}} FCFA effectue. Ref: {{reference}}. ' + APP_NAME + '',
      placeholders: 'clientName,amount,reference',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{employeeName}}, votre conge du {{startDate}} au {{endDate}} a ete approuve. ' + APP_NAME + '',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{employeNom}}, votre demande de conge a ete refusee. Motif: {{reason}}. Contactez votre RH. ' + APP_NAME + '',
    ...
    // ── Credit lifecycle SMS templates ──
    {
      ...
      contenu: 'Bonjour {{clientName}}, votre demande de credit ({{creditNumber}}) de {{amount}} FCFA a ete enregistree. Nous la traitons dans les plus brefs delais. ' + APP_NAME + '',
    ...
    },
    {
      ...
      contenu: 'Felicitations {{clientName}} ! Votre credit n°{{creditNumber}} de {{amount}} FCFA a ete APPROUVE. Passez en agence pour le decaissement. ' + APP_NAME + '',
      placeholders: 'clientName,creditNumber,amount',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, une enquete terrain a ete assignee pour votre dossier {{creditNumber}}. Un agent vous contactera prochainement. ' + APP_NAME + '',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': Bonjour {{clientName}}, votre echeance credit {{creditNumber}} est en retard de {{daysOverdue}} jours. Regularisez votre situation rapidement.',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': Rappel - Votre echeance de {{amount}} FCFA pour le credit {{creditNumber}} arrive le {{dueDate}}. Pensez a provisionner.',
    ...
    },
    {
      ...
      contenu: 'Felicitations {{clientName}} ! Votre credit {{creditNumber}} est entierement rembourse ({{totalPaid}} FCFA). Merci de votre confiance. ' + APP_NAME + '',
      placeholders: 'clientName,creditNumber,totalPaid',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, votre remboursement de frais ({{amount}} FCFA, Ref: {{reference}}) a ete approuve. Le paiement sera effectue sous peu. ' + APP_NAME + '',
      placeholders: 'clientName,amount,reference',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, {{amount}} FCFA vous ont ete rembourses (Ref: {{reference}}). Merci de votre confiance. ' + APP_NAME + '',
      placeholders: 'clientName,amount,reference',
    ...
    // ── Tontine SMS templates ──
    {
      ...
      contenu: 'Bienvenue {{clientName}} ! Vous etes inscrit(e) a la tontine {{tontineName}}. Cotisation: {{amount}} FCFA ({{frequence}}). ' + APP_NAME + '',
      placeholders: 'clientName,tontineName,amount,frequence',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, cotisation de {{amount}} FCFA pour {{tontineName}} enregistree. Merci. ' + APP_NAME + '',
      placeholders: 'clientName,tontineName,amount',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{clientName}}, cotisation {{tontineName}} en retard de {{daysOverdue}} jours ({{amount}} FCFA, echeance {{dueDate}}). Regularisez rapidement.',
      placeholders: 'clientName,tontineName,amount,dueDate,daysOverdue',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{clientName}}, penalite de {{montantPenalite}} FCFA appliquee sur {{tontineName}} ({{motif}}). Contactez votre agence.',
      placeholders: 'clientName,tontineName,montantPenalite,motif',
    ...
    },
    {
      ...
      contenu: 'Felicitations {{clientName}} ! Distribution {{tontineName}} approuvee: {{amount}} FCFA ({{payoutMethod}}). ' + APP_NAME + '',
      placeholders: 'clientName,tontineName,amount,payoutMethod',
    ...
    },
    {
      ...
      contenu: 'Felicitations {{clientName}} ! {{amount}} FCFA verses pour {{tontineName}} (Ref: {{reference}}). ' + APP_NAME + '',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, cycle {{cycleNumber}} de {{tontineName}} demarre le {{startDate}}. Cotisations ouvertes. ' + APP_NAME + '',
      placeholders: 'clientName,tontineName,cycleNumber,startDate',
    ...
    // ---- Phase 3: Comptes & Épargne SMS templates ----
    {
      ...
      contenu: 'Bonjour {{clientName}}, votre compte {{accountType}} N°{{accountNumber}} a ete ouvert. Rendez-vous a votre agence. ' + APP_NAME + '',
      placeholders: 'clientName,accountNumber,accountType',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, compte {{accountNumber}} active ! Depot initial: {{amount}} FCFA. Operations disponibles. ' + APP_NAME + '',
      placeholders: 'clientName,accountNumber,accountType,amount',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': Depot de {{amount}} FCFA sur {{accountNumber}}. Solde: {{balance}} FCFA.',
      placeholders: 'clientName,accountNumber,amount,balance',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': Retrait de {{amount}} FCFA sur {{accountNumber}}. Solde: {{balance}} FCFA.',
      placeholders: 'clientName,accountNumber,amount,balance',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{clientName}}, compte {{accountNumber}} bloque ({{motif}}). Depots autorises. Contactez votre agence.',
      placeholders: 'clientName,accountNumber,motif',
    ...
    },
    {
      ...
      contenu: 'Bonne nouvelle {{clientName}} ! Compte {{accountNumber}} debloque. Operations disponibles. ' + APP_NAME + '',
      placeholders: 'clientName,accountNumber',
    ...
    },
    {
      ...
      contenu: 'Bonjour {{clientName}}, compte {{accountType}} N°{{accountNumber}} cloture. Merci de votre confiance. ' + APP_NAME + '',
      placeholders: 'clientName,accountNumber,accountType',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{clientName}}, interets de {{interestAmount}} FCFA credites sur {{accountNumber}}. Solde: {{newBalance}} FCFA.',
      placeholders: 'clientName,accountNumber,interestAmount,newBalance',
    ...
    // ── Phase 4: Opérations & Sécurité ──
    {
      ...
      contenu: '' + APP_NAME + ': {{clientName}}, virement de {{amount}} FCFA de {{fromAccount}} vers {{toAccount}} execute avec succes.',
      placeholders: 'clientName,amount,fromAccount,toAccount',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{clientName}}, echec du virement de {{amount}} FCFA depuis {{fromAccount}}. {{retryInfo}}. Contactez votre agence.',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{employeeName}}, demande de conge ({{leaveType}}) du {{startDate}} au {{endDate}} enregistree. Vous serez notifie.',
      placeholders: 'employeeName,leaveType,startDate,endDate',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': Votre session caisse a ete fermee automatiquement. {{details}}',
    ...
    // ── Phase 5: Client Lifecycle, Utilisateurs & Opérations Terrain ──
    {
      ...
      contenu: 'Bienvenue {{clientName}} chez ' + APP_NAME + ' ! Votre inscription est confirmee.{{#if accountNumber}} Compte: {{accountNumber}}.{{/if}} Merci de votre confiance.',
      placeholders: 'clientName,accountNumber',
    ...
    },
    {
      ...
      contenu: 'Bienvenue {{employeeName}} chez ' + APP_NAME + ' ! Matricule: {{matricule}}. Bonne integration dans l\'equipe.',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{userName}}, votre compte a ete cree. Identifiant: {{username}} / Mot de passe: {{password}}. Changez-le a la premiere connexion.',
      placeholders: 'userName,username,password',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{clientName}}, paiement de {{amount}} FCFA ({{paymentType}}) confirme. Merci !',
    ...
    // ── Phase 6: Codes d'accès caisse & Permissions temporaires ──
    {
      ...
      contenu: '' + APP_NAME + ': {{userName}}, votre code d\'acces caisse: {{code}}. Type: {{codeType}}. Valide {{validityHours}}h, autorisation {{authorizationHours}}h.{{#if description}} Motif: {{description}}.{{/if}} Ne partagez jamais ce code.',
      placeholders: 'userName,code,codeType,validityHours,authorizationHours,description',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{userName}}, votre code caisse ({{code}}) expire dans {{timeRemaining}}. Utilisez-le ou demandez un nouveau code.',
      placeholders: 'userName,code,expiresAt,timeRemaining',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{userName}}, permission "{{permissionName}}" accordee jusqu\'au {{expiresAt}} par {{grantedBy}}.',
      placeholders: 'userName,permissionName,permissionCode,expiresAt,grantedBy,reason',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{userName}}, permission "{{permissionName}}" expire dans {{timeRemaining}}. Contactez votre responsable si besoin.',
      placeholders: 'userName,permissionName,permissionCode,expiresAt,timeRemaining',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{userName}}, permission "{{permissionName}}" a expire le {{expiredAt}}. Demandez une nouvelle autorisation si necessaire.',
      placeholders: 'userName,permissionName,permissionCode,expiredAt',
    ...
    },
    {
      ...
      contenu: '' + APP_NAME + ': {{userName}}, permission "{{permissionName}}" revoquee par {{revokedBy}}.{{#if reason}} Motif: {{reason}}.{{/if}}',
      placeholders: 'userName,permissionName,permissionCode,revokedBy,reason',
