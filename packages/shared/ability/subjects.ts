...
export const Subjects = {
  ...
  LOGE: 'loge',
  KPI: 'kpi',
  CARTES_POINTAGE: 'cartes-pointage',
...
export const SUBJECT_LABELS: Record<Subject, string> = {
  ...
  [Subjects.CARTES_POINTAGE]: 'Cartes de Pointage',
  [Subjects.CARTE_POINTAGE]: 'Carte de pointage',
  [Subjects.CARTE_POINTAGE_TRANSACTION]: 'Transaction carte de pointage',
  ...
  [Subjects.EVACUATION_COFFRE]: 'Évacuation coffre',
...
export const MODULE_ENTITY_MAP: Record<string, Subject[]> = {
  ...
  [Subjects.CARTES_POINTAGE]: [Subjects.CARTE_POINTAGE, Subjects.CARTE_POINTAGE_TRANSACTION],
  [Subjects.CAISSE]: [Subjects.CAISSE_SESSION, Subjects.CAISSE_OPERATION, Subjects.CAISSE_AGENT],
  [Subjects.COFFRE]: [Subjects.COFFRE_TRANSFERT, Subjects.EVACUATION_COFFRE],
