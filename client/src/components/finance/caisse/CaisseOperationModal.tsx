...
import {
  X, ArrowDownToLine, ArrowUpFromLine, Banknote, FileCheck,
  Building2, Smartphone, Loader2, CheckCircle2, Lock, AlertTriangle,
...
const PAYMENT_METHODS: { id: MethodePaiementType; label: string; icon: React.FC<{ size?: number; className?: string }> }[] = [
  ...
  { id: MethodePaiement.CHECK, label: 'Chèque', icon: FileCheck },
  { id: MethodePaiement.TRANSFER, label: 'Virement', icon: Building2 },
  { id: MethodePaiement.MOBILE_MONEY, label: 'Mobile', icon: Smartphone },
];
  ...
  return (
    ...
    >
      <div className="bg-slate-900 rounded-2xl border border-slate-700 max-w-lg w-full shadow-2xl relative overflow-hidden">
        ...
        {/* ─── PHASE: CONFIRMING ─── */}
        {phase === 'CONFIRMING' && selectedAccount && (
