...
const Badge: React.FC<BadgeProps> = ({
  ...
  const getVariantFromValue = (val: string | React.ReactNode): BadgeVariant => {
    ...
    const warningStates = [
      'PENDING', 'PENDING_FEES', 'PENDING_ACTIVATION', 'PENDING_APPROVAL', 'SUSPENDED', 'IN_TRANSIT', 'SUBMITTED', 'DRAFT',
      'REEVALUATION_IN_PROGRESS', 'READY_FOR_INVESTIGATION', 'UNDER_INVESTIGATION', 'INVESTIGATION_COMPLETE',
      'EN ATTENTE', 'SUSPENDU', 'EN COURS', "EN COURS D'ANALYSE", "EN COURS D'APPROBATION", 'BROUILLON', 'SOUMIS', 'EN TRANSIT',
