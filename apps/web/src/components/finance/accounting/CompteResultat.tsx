...
import { exportCompteResultatExcel, exportCompteResultatPDF, CompteResultatLineExport } from './exports/compteResultatExports';

interface CompteResultatLine extends CompteResultatLineExport {}
...
export default function CompteResultat() {
  ...
  const handleExportExcel = async () => {
    await exportCompteResultatExcel(
      charges,
      produits,
      totalCharges,
      totalProduits,
