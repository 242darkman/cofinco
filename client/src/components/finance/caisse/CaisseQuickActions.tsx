    ...
    <>
      <div className="flex items-center gap-2">
           ...
           <div 
             ...
             className="flex-1 flex items-center gap-3 p-3 rounded-lg border border-accent/20 bg-accent/5 hover:bg-accent/10 cursor-pointer transition-colors group"
           >
              <div className="p-2 rounded-lg bg-accent/10 text-accent group-hover:scale-105 transition-transform">
                <CreditCard size={20} />
              </div>
              <div>
                <span className="text-sm font-bold text-content-primary block">Nouvelle Opération</span>
                <span className="text-[10px] text-accent/70 font-medium">Encaissement • Décaissement</span>
              </div>
           </div>
           ...
           >
              ...
              <div>
                <span className="text-sm font-bold text-content-primary block">Coffre-Fort</span>
                <span className="text-[10px] text-accent/70 font-medium">Approvisionnement • Versement</span>
              </div>
           </div>
      </div>
