      ...
      {enqueteFormData && (
        <EnqueteWizard
          ...
          initialData={{
            ...
            creditPlan: (enqueteFormData as any).creditPlan || null,
            clientSituation: (enqueteFormData as any).clientSituation || null,
            situationMatrimoniale: (enqueteFormData as any).situationMatrimoniale,
            personnesCharge: (enqueteFormData as any).personnesCharge,
            typeHabitation: (enqueteFormData as any).typeHabitation,
            garantiesProposees: (enqueteFormData as any).garantiesProposees,
            autresCredits: (enqueteFormData as any).autresCredits,
            photosActivite: (enqueteFormData as any).photosActivite,
            documentsJustificatifs: (enqueteFormData as any).documentsJustificatifs,
            agentRecommendation: (enqueteFormData as any).agentRecommendation,
            recommendedAmount: (enqueteFormData as any).recommendedAmount,
            riskLevel: (enqueteFormData as any).riskLevel,
            riskFactors: (enqueteFormData as any).riskFactors,
            observations: (enqueteFormData as any).observations,
            geoLatitude: (enqueteFormData as any).geoLatitude,
            geoLongitude: (enqueteFormData as any).geoLongitude,
            geoAccuracy: (enqueteFormData as any).geoAccuracy,
            geoTimestamp: (enqueteFormData as any).geoTimestamp,
            client: (enqueteFormData as any).client,
          }}
